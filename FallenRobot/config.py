class Config(object):
    ...
    DATABASE_URL = "postgres://carcel_group_management_bots_user:NF8DAlQETxlp3u4QKLs6fqMRH7UyJfDk@dpg-cm5hrden7f5s73c5ibfg-a/carcel_group_management_bots"  # A sql database url from elephantsql.com
