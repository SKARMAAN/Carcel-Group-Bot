class Config(object):
    ...
    DATABASE_URL = "postgres://zklsxczz:75NjENBjm_5NNpdrzsJsHxZDuZeNxBPg@mel.db.elephantsql.com/zklsxczz"  # A sql database url from elephantsql.com
    ...
    DRAGONS = [6260714402]  # User id of sudo users
